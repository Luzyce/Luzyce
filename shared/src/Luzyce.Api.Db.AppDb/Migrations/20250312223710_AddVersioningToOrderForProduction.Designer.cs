...
namespace Luzyce.Api.Db.AppDb.Migrations
{
    ...
    [Migration("20250312223710_AddVersioningToOrderForProduction")]
    partial class AddVersioningToOrderForProduction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Luzyce.Api.Db.AppDb.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 12, 23, 37, 10, 156, DateTimeKind.Unspecified).AddTicks(568),
                            Email = "admin@gmail.com",
                            Hash = "admin",
                            LastName = "Admin",
                            Login = "admin",
                            Name = "Admin",
                            Password = "$2a$11$3kdc568OWRYiPzAHAtu84uj7hPOuaXziDQcJp/9Aq6mrqOxJp4gbC",
                            RoleId = 1
                        });
                });
