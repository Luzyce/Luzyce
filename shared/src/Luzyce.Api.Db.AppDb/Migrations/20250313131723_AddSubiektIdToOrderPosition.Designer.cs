...
namespace Luzyce.Api.Db.AppDb.Migrations
{
    ...
    [Migration("20250313131723_AddSubiektIdToOrderPosition")]
    partial class AddSubiektIdToOrderPosition
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Luzyce.Api.Db.AppDb.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 13, 14, 17, 23, 170, DateTimeKind.Unspecified).AddTicks(54),
                            Email = "admin@gmail.com",
                            Hash = "admin",
                            LastName = "Admin",
                            Login = "admin",
                            Name = "Admin",
                            Password = "$2a$11$Hmijp0b5neGd2oGZS4Hc/uoDq.Q5bhpAGq4EGUwi0NshU6fH.0KoS",
                            RoleId = 1
                        });
                });
