...
namespace Luzyce.Api.Db.AppDb.Migrations
{
    ...
    [Migration("20250314140439_AddIsDeletedToDocumentPositions")]
    partial class AddIsDeletedToDocumentPositions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Luzyce.Api.Db.AppDb.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 3, 14, 15, 4, 38, 575, DateTimeKind.Unspecified).AddTicks(8956),
                            Email = "admin@gmail.com",
                            Hash = "admin",
                            LastName = "Admin",
                            Login = "admin",
                            Name = "Admin",
                            Password = "$2a$11$svwbEi3iahh8PRByR9.cHe4ex/0fOaEOUhm6CeophiWKtnuWZXk.O",
                            RoleId = 1
                        });
                });
